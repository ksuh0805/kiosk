...
import com.samilcts.app.mpaio.demo2.MpaioBaseActivity;
...
public class CashbeeReceiptActivity extends MpaioBaseActivity {
    ...
    private void setReceiptData() {
        ...
        tvIssuer.setText(R.string.title_samil_prepaid_card);
