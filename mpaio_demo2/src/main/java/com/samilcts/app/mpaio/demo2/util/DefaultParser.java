...
import com.samilcts.app.mpaio.demo2.data.DeviceInfo;
...
public class DefaultParser {
    ...
    /**
     * mpos ble address prefix
     */
    static final String PREFIX_BLE_ADDRESS = "Samil";
    ...
    public CardInfo parseMSCardData(byte[] data) {
        ...
        if ( idxStartName > -1 && idxStartDate > idxStartName ) {
            ...
            String name = T1.substring(idxStartName+1, idxStartDate).trim();
