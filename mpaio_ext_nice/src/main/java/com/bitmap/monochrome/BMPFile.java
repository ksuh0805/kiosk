...
public class BMPFile {
	 ...
	 */
	private void writeBitmapFileHeader(OutputStream fos) throws IOException {
	...
	private void writeBitmapInfoHeader(OutputStream fos) throws IOException {
	...
	private void writePixelArray(OutputStream fos) throws IOException {
